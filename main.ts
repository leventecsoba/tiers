...
const createDragTarget = (dragTargetContainer: Element) => {
    const existingDragTarget = [...dragTargetContainer.children].find((e) => e.id === "drag-target")
...
const destroyDragTarget = (dragTargetContainer: Element) => {
    const dragTarget = [...dragTargetContainer.children].find((e) => e.id === "drag-target")
    if (dragTarget) {
...
const initDragging = () => {
    ...
    window.addEventListener("mousemove", (e) => {
        ...
        for (const dragTargetContainer of dragTargetContainers) {
            ...
            const doesXOverlap = e.clientX > dragTargetContainerX && e.clientX < dragTargetContainerX + dragTargetContainerWidth
            const doesYOverlap = e.clientY > dragTargetContainerY && e.clientY < dragTargetContainerY + dragTargetContainerHeight
